...
def trainer(env, agent, num_episodes=100000, num_steps_in_episode=5000, render=False,
            solved_checkpoint_name='checkpoint.pth', save_checkpoint=False, verbose=False):
    """Deep Q-Learning.
    ...
    num_episodes_to_solve = num_episodes
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if np.mean(scores_window) >= 475:
            ...
            num_episodes_to_solve = episode - 100
            break
    return scores, num_episodes_to_solve
